...
<head>
    <meta charset="UTF-8">
    <title>Admin Portal - IRCTC</title>
    ...
    <style>
        * {
        ...
        body::before {
            ...
            height: 100%;
            background: 
                radial-gradient(circle at 25% 25%, rgba(100, 116, 139, 0.03) 0%, transparent 50%),
        ...
        .login-card::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(100, 116, 139, 0.015), rgba(148, 163, 184, 0.015));
            pointer-events: none;
        }
...
<body>
        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Secure login for system administrators</p>
                </div>
                ...
                <div class="security-notice">
                    ...
                    <div>
                        <strong>Security Notice:</strong> This is a restricted area. All access attempts are logged and monitored. Only authorized personnel should proceed.
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            // Alt + A to focus username field (Admin)
            if (e.altKey && e.key === 'a') {
                e.preventDefault();
                document.getElementById('username').focus();
            }
